      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-96">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm p-2 border bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-blue-500"
              value={username}
        ...
        <div className="mt-4 text-center text-sm">
          {isLogin ? (
            <p className="text-gray-700 dark:text-gray-300">Don't have an account? <Link to="/register" className="text-blue-600 dark:text-blue-400 hover:underline">Sign up</Link></p>
          ) : (
            <p className="text-gray-700 dark:text-gray-300">Already have an account? <Link to="/login" className="text-blue-600 dark:text-blue-400 hover:underline">Log in</Link></p>
          )}
        </div>
